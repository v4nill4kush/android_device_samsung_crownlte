def FullOTA_Assertions(info):
    ...
    info.script.AppendExtra('ifelse(file_getprop("/vendor/build.prop","ro.vendor.build.date.utc") != "1549933773",');
    ...
    info.script.AppendExtra('ui_print("          Expected version: XXS2ASB1         ");');
    info.script.AppendExtra('ui_print("=============================================");');
